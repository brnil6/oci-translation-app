### Start : These information are theorically needed only outside of OCI Terraform Stack Manager
### But we need them all the time in this use case for building oci config file in the container 
